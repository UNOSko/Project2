...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.hotkeyDisplay.setText(_translate("MainWindow", f"{self.hotkey}"))
        ...
        if self.onState:
            ...
            if self.chosenLocation.isChecked():
                ...
                if self.repeatInfinite.isChecked():
                    ...
                    while i:
                        if self.hotkeyNone.isChecked():
                            if keyboard.read_key() == self.hotkey:
                ...
                if self.repeatFinite.isChecked():
                    try:
                        self.repeatTimes.setText("int(self.repeatTimes.text())")
                        if int(self.repeatTimes.text()) < 1:
                            self.repeatTimes.setText("1")
                    except Exception:
                        self.repeatTimes.setText("10")
